...
from datasets.MNIST import MNISTIndAttribute
from dataloaders.get_data_loader import get_loaders
from models.networks import MNIST_MLP, Classifier, MLP
from algorithms.CACM import CACM
from algorithms.CDANN import CDANN
data_dir = 'data'
...
trainer = pl.Trainer(devices = 1, max_epochs=32)
